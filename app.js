...
const app=express();
const port=3000;
const uri="mongodb+srv://gautam1224:gautam1224@cluster0.a4flvpj.mongodb.net/?retryWrites=true&w=majority"
...
const transporter = nodemailer.createTransport({
    ...
    secure: true,
    auth: {
     user: 'gautamgarg0412@gmail.com',
     pass: 'darephklpbxgzgsu',
    },
   });
...
const info = await transporter.sendMail({
    from: 'gautamgarg0412@gmail.com', // sender address
    to: `${data.email}`, // list of receivers
    subject: "Successfull Login", // Subject line
     // plain text body
    html:`<h1>HELLO ${data.role}</h1>` // html body
  });
   }
   else{
    res.redirect("/login");
